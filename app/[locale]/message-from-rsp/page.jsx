		...
		<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-48">
			...
			<div className="bg-white rounded-3xl shadow-md overflow-hidden">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
					...
					{/* Letter Section */}
					<div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-neutral-100">
						<div className="space-y-4">
							{/* Greeting */}
							{/* <div>
									<h3 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-2">संस्थापक संयोजकको स्वागत मन्तव्य</h3>
								</div> */}
							...
							<div className="space-y-4 text-neutral-700 leading-relaxed text-lg">
								...
								<p className="font-medium text-neutral-900">धन्यवाद।</p>
							</div>
							...
							<div className="pt-6 border-t border-neutral-200">
								<div className="flex items-end gap-4">
									<div>
										<p className="text-2xl font-bold text-neutral-900 mb-1" style={{ fontFamily: "cursive" }}>
											सरोज थापा
										</p>
										<p className="text-sm text-neutral-600 font-medium">संस्थापक संयोजक, प्रवास नेपाली सम्पर्क विभाग नर्वे</p>
									</div>
								</div>
							</div>
						</div>
