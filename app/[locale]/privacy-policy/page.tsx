		...
		<div className="py-8">
			...
			<header className="">
				<div className="max-w-4xl mx-auto px-4 py-6">
					<h1 className="text-3xl font-bold text-neutral-900">RSP Web/App Privacy Policy</h1>
					<p className="text-sm text-neutral-600 mt-2">Last Updated: December 2025</p>
				</div>
			</header>
			...
			<main className="max-w-4xl mx-auto px-4 py-8">
				<div className="bg-white rounded-lg shadow-md p-8 space-y-8">
					{/* Introduction */}
					<section>
						<p className="text-neutral-700 leading-relaxed">This Privacy Policy will help you understand what data we collect, why we collect it and what we do with it. By downloading this app you understand and accept the contents of this privacy policy and its subsequent versions. We appreciate & acknowledge the informed consent granted by you while downloading the App, using its features and/or submitting your information within the App.</p>
					</section>

					{/* Collection */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Collection</h2>
						<p className="text-neutral-700 leading-relaxed">To provide a tailor made and personalised experience, the information you share maybe processed and analysed by third party services who are engaged by us with due confidentiality obligations and solely for the specific purpose of such services. This will help the App give you the best possible experience by showing content in your language and according to your interests. For example, based on the location data collected, you may get a push notification when RSP is doing event is in your province or district or there is an important initiative or event happening in your location. Similarly, based on your previous interactions within the App you may receive push notifications based on your interests in the future.</p>
					</section>

					{/* Permissions */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Permissions</h2>
						...
						<p className="text-neutral-700 leading-relaxed mt-4">Similarly functionality related to Sticky Broadcast, Flashlight, Vibration, Prevent device from sleeping, service configurations and others are used only for purposes of providing reliable and efficient functionality. The permissions asked for are used only for a specific feature or user action. For example, permission to use photos is used only when you want to post a photo and the file storage permission is used only to store the photo on the device.</p>
					</section>

					{/* Use */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Use</h2>
						<p className="text-neutral-700 leading-relaxed mb-4">The following information collected by the App is used only for the purposes mentioned below:</p>
					...
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Transparency and Choice</h2>
						<p className="text-neutral-700 leading-relaxed">You are free to grant or deny the permissions listed above and utilise the App with a subset of the features you choose to avail at any given time. We may update our Privacy Policy from time to time. When we change the policy in a material way, a notice will be posted on our website along with the updated Privacy Policy.</p>
					</section>

					{/* Termination */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Termination of the use of personal information collected from the user</h2>
						<p className="text-neutral-700 leading-relaxed">
							The user may request the deletion of their data by sending an email to{" "}
							<a href="mailto:info@rspnorway.org" className="text-info-600 hover:text-info-700 underline">
								info@rspnorway.org
							</a>{" "}
					...
					{/* Voting Counts */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Voting Counts</h2>
						<p className="text-neutral-700 leading-relaxed mb-3">If the votes received between the candidates are equal, the basis for election will be as follows:</p>
						<div className="bg-neutral-50 rounded-lg p-4 space-y-2">
							<div className="flex items-start">
								<span className="font-semibold text-neutral-900 mr-2">1.</span>
								<span className="text-neutral-700">First woman on the basis of priority.</span>
							</div>
							<div className="flex items-start">
								<span className="font-semibold text-neutral-900 mr-2">2.</span>
								<span className="text-neutral-700">The second minority and caste basis are minorities, Dalits, Tharu, Muslims, Madheshi, tribal tribes and Khasarya respectively.</span>
							</div>
							<div className="flex items-start">
								<span className="font-semibold text-neutral-900 mr-2">3.</span>
								<span className="text-neutral-700">If the above priorities are also repeated, the youth (younger age) will be elected on the basis of priority</span>
							</div>
						</div>
					</section>
					...
					{/* Donations */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">Donations</h2>
						<p className="text-neutral-700 leading-relaxed">RSP is a member-based party and your contributions is the bases on which the party operates. Please read the respective terms and conditions of the payment gateways app before donating.</p>
					</section>

					{/* User Safety */}
					<section>
						<h2 className="text-2xl font-semibold text-neutral-900 mb-4">User Safety and Security</h2>
						<p className="text-neutral-700 leading-relaxed">We value all personal information provided by you and we shall ensure the safety and security of information you provide in the App. Your data shall not be sold or rented to anyone and will only be utilised for the functionality of the App and related features, services, etc.</p>
					</section>

					{/* Contact */}
					<section className="bg-blue-50 rounded-lg p-6 border border-blue-100">
						<h2 className="text-xl font-semibold text-neutral-900 mb-3">Questions or Concerns?</h2>
						<p className="text-neutral-700 leading-relaxed">If you have any questions or concerns about our Privacy Policy or data usage, please write to us on the Help & Feedback section of the App.</p>
					</section>
					...
					<section className="border-t border-neutral-200 pt-6">
						...
						<div className="flex flex-wrap gap-3">
							...
							<Link href="mailto:info@rspnorway.org" className="inline-flex items-center px-4 py-2 bg-neutral-600 text-white rounded-lg hover:bg-neutral-700 transition-colors">
								<svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
	...
	return (
		<div className="flex items-start">
			...
			<p className="text-neutral-700">
				<span className="font-semibold text-neutral-900">{type}</span> {purpose}
			</p>
		</div>
	);
}
