...
// 				{/*
// 				NOTE: Check all color combinations (e.g., .bg-brand/5, .text-brand, .text-gray-900) for sufficient contrast using a tool like WebAIM Contrast Checker or Lighthouse.
...
// 									{t.form.name}
// 								</label>
// 								<input id="name" type="text" name="name" value={form.name} onChange={handleChange} required className="mt-1 block w-full rounded-md border border-light bg-white/80 shadow focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:outline-none px-4 py-2 text-gray-900 placeholder-neutral-400" placeholder={t.form.name_placeholder} autoComplete="name" aria-required="true" />
// 							</div>
// 							<div>
// 								<label htmlFor="email" className="block text-sm font-medium text-gray-900">
// 									{t.form.email}
// 								</label>
// 								<input id="email" type="email" name="email" value={form.email} onChange={handleChange} required className="mt-1 block w-full rounded-md border border-light bg-white/80 shadow focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:outline-none px-4 py-2 text-gray-900 placeholder-neutral-400" placeholder={t.form.email_placeholder} autoComplete="email" aria-required="true" />
// 							</div>
// 							<div>
// 								<label htmlFor="message" className="block text-sm font-medium text-gray-900">
// 									{t.form.message}
// 								</label>
// 								<textarea id="message" name="message" value={form.message} onChange={handleChange} required rows={5} className="mt-1 block w-full rounded-md border border-light bg-white/80 shadow focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:outline-none px-4 py-2 text-gray-900 placeholder-neutral-400" placeholder={t.form.message_placeholder} aria-required="true" />
// 							</div>
...
// 								<address className="text-gray-900 not-italic">{typedSettings?.[0]?.address}</address>
// 							</div>
// 						</div>
// 						<div className="row-span-1 mb-2 md:mb-0 flex items-start gap-4">
...
// 								<a className="text-gray-900 underline" href={`tel:${typedSettings?.[0]?.phone}`}>
...
// 								<a className="text-gray-900 underline" href={`mailto:${typedSettings?.[0]?.email}`}>
