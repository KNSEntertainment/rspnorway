...
import { User, Mail, Phone, Calendar, Shield, CheckCircle, Clock, XCircle, Users, Camera, Upload, AlertCircle, CreditCard, Trash2, Download } from "lucide-react";
...
Generated by: PNSB-Norway Membership System
	...
	return (
		...
		<div className="w-full flex flex-col md:flex-row space-y-1 md:space-x-1 items-center justify-center">
			<Button onClick={() => setShowDeleteDialog(true)} variant="outline" className="w-fit text-red-600 hover:bg-red-50 hover:text-red-600 border-red-200 my-12">
