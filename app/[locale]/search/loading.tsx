		...
		<div className="min-h-screen bg-neutral-50 py-12">
			<div className="container mx-auto px-4 max-w-6xl">
				<div className="flex flex-col items-center justify-center py-20">
					...
					<h2 className="text-2xl font-semibold text-neutral-700 mb-2">Searching...</h2>
					<p className="text-neutral-600 animate-pulse">Please wait while we find the best results for you</p>
