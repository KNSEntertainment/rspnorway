	...
	return (
		<section id="blog" className="">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
				...
				<div className="w-24 h-1 bg-[#0094da] mx-auto mb-4 md:mb-8 rounded-full"></div>

				{/* Loading overlay for navigation */}
				{navLoading && (
					<div className="fixed inset-0 z-50 flex items-center justify-center bg-white bg-opacity-70">
						<div className="flex flex-col items-center">
							<svg className="animate-spin h-10 w-10 text-[#0094da] mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
								<circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
								<path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"></path>
							</svg>
							<span className="text-[#0094da] font-semibold">Loading...</span>
						</div>
					</div>
				)}
								...
								blogs.map((blog) => (
									<div key={blog._id} className="group bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-lg hover:translate-y-[-4px]">
										...
										<div className="flex flex-row md:flex-col h-32 md:h-auto">
											...
											<div className="relative flex-shrink-0 w-28 h-28 md:w-full md:h-64 overflow-hidden">
											...
											<div className="flex flex-col justify-center p-4 md:p-6 space-y-2 w-full">
												...
												<h1 className="text-base md:text-2xl font-bold mb-2 cursor-pointer group-hover:text-[#0094da]">
													<button
