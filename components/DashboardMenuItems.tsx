...
export const menuItems: MenuItem[] = [
	...
	{ id: "finances", label: "Financial Analytics", icon: TrendingUp, color: "bg-emerald-600", href: "/en/dashboard/finances" },
	{ id: "financial-management", label: "Financial Management", icon: Receipt, color: "bg-blue-600", href: "/en/dashboard/financial-management" },
	...
	{ id: "send-messages", label: "Send Messages", icon: Send, color: "bg-blue-500", href: "/en/dashboard/send-message" },
